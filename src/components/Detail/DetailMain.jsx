...
import AccordionComponent from '../BootStrap/AccordionComponent';

const DetailMain = ({pageId}) => {
    ...
    const mapElement = useRef(null);
      ...
      const location = new naver.maps.LatLng(37.550589244702074, 126.97263080003962);
    ...
    const num1 = 500000;
    const num2 =  num1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
  ...
  return (
    <div className="detail_wrap">
            <div className="detail_wrap_left">
                <div className="main_img">
                    <DetailSlider pageId={Number(id)} slideimg={"https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F22333%2Feh1mycy7nnltf5ah__1080_790.jpg&w=1000&q=75"} />
                    
                </div>
                <DetailTop pageId={Number(id)} /> 
                <div className="txt2">
                    <p>
                        ＜서비스 소개＞<br /><br />
                        ...
                        Medmap은 정확하고 다양한 3D 메디컬 콘텐츠를 제공하여 시술 원리와 과정을 쉽게 설명할 수 있도록 도와줍니다. 또한 환자의 이해를 돕고 신뢰도를 향상 시키며 재방문율을
                        높일 수 있습니다.<br />
                        블루비커는 자유롭고 수평적인 분위기에서 각 분야 전문가인 동료들과 최대한의 능력을 발휘하며 함께하고 있습니다. 원하는 시간과 장소, 언제 어디서나, 블루비커와 함께 할 수
                        있습니다.<br /><br />

                        블루비커는 의료 분야 커뮤니케이션 서비스의 신규 개발과 고도화를 진행하고 있습니다. 다양한 최신 기술을 시도하고 접하실 수 있습니다. 저희 회사에 관심이 있다면 언제든지
                        귀한 능력을 받아들일 준비가 되어있습니다.<br /> 많은 지원 부탁드립니다.<br /><br />
                ...
                <div className="info">
                    ...
                    <div className="follow_box">
                        <div className="left">
                            <img src="https://static.wanted.co.kr/images/wdes/0_5.0852ff23.jpg" />
                    ...
                    {/* <div className="warning_wrap"> */}
                        ...
                        {/* <div className="warning">
                            <h4>본 채용정보는 원티드랩의 동의없이 무단전재, 재배포, 재가공할 수 없으며, 구직활동 이외의 용도로 사용할 수 없습니다.</h4>
            ...
            <div className="detail_wrap_right">
                <h3>채용보상금</h3>
                <ul>
                    <li>
                        <h4>추천인</h4>
                ...
                <FontAwesomeIcon icon={faShareAlt} className='shareicon' />
                </div>
                <div className={'btn1'} onClick={()=>{dispatch({type:'OFF'}) }}>
                <FontAwesomeIcon icon={faBookmark} className="bookmarkicon" />
                    북마크하기</div>
                <div className="btn2">지원하기</div>
                <div className="bottom">
                    ...
                    <div className="profile">
                        <ul>
                            <li><img src="https://k.kakaocdn.net/dn/chOGWm/btrJ7se3l3K/eeQiZuGgc7rBHKj9RBRFk1/img_110x110.jpg"
                                    alt=""/></li>
                            <li><img src="https://lh3.googleusercontent.com/a/AATXAJyptvBO9pOC55mAwO0IA3-llT_OIJ3QyPcS1-DN=s96-c"
                                    alt=""/></li>
                            <li><img src="https://static.wanted.co.kr/images/userweb/profile_default.png" alt=""/></li>
                        </ul>
                    </div>
                </div>
            </div>
